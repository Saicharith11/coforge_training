...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> SupplierEmployeeNotFoundException(SupplierNotFoundException e) {
		return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(MethodArgumentNotValidException.class) // to handle specific exception
	public ResponseEntity<?> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
		return new ResponseEntity<>(environment.getProperty("sms.invalid.employee-details"), HttpStatus.BAD_REQUEST);
	}
